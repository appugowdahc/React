  ...
  return (
    <div className="site-container">
      <header className="page-header">
        <div className="title">
          <a href="http://localhost:3004/">Insta Clone</a>
        </div>
          ...
          return (
            <section className="post" key={user.id}>
              <header>
                ...
                <a href={`http://localhost:3004/${user.id}`}>
                  <h3>{user.name}</h3>
                  </a>
      ...
      <footer>
        ...
        <a href="http://localhost:3004/">{leftArrow}</a>

        <p>1 of 1</p>

        <a href="http://localhost:3004/">{rightArrow}</a>
      </footer>
    </div>
  );
}
